...
Once this works, switch out the contents of the popper to something that has nested keyboard navigation (another table within the popper).
...
**Important:** The popper logic should respond to external focus events. Ie, if an element is programmatically focused outside of the popper context, it should close the popper.
